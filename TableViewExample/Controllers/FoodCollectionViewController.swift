...
//  TableViewExample
//
//  Created by Yamusa Dalhatu on 9/28/20.
//
...
class FoodCollectionViewController: UICollectionViewController {
    ...
    */
    ...
    let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! ShopCollectionViewCell
        ...
        // For every cell, populate the Coffee name label from coffeeshopnames array above
        cell.coffeeShopName.text = coffeeShopNames[indexPath.item]
